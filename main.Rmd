...
Silla %>%
  ...
  geom_line(col = "blue") +
  labs(title = "Reducción de Polución de Dióxido de Nitrógeno en la Pista Silla esta decada",y = "Dióxido de Nitrógeno (NO2)")
...
Silla %>%
  ...
  geom_line(col = "blue") +
  labs(title = "Reducción de Polución de Dióxido de Nitrógeno en la Pista Silla esta decada",y = "Dióxido de Nitrógeno (NO2)") + xlab("Año")
